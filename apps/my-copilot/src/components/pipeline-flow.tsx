...
const STEPS = [
  {
    ...
    description: "Finner blindsoner som dataklassifisering, auth-type, PII-risiko og avhengigheter.",
  ...
  },
  {
    ...
    color: "#60a5fa",
    items: [
      "Auth-beslutning mellom ID-porten, Azure AD, TokenX og Maskinporten",
      "Nais-manifest som ferdig YAML med riktige ressurser og accessPolicy",
      "Prosjektstruktur i form av mappestruktur for valgt arketype",
      "CI/CD som GitHub Actions workflow med build, test, deploy",
      "Teststrategi med riktig testnivå per komponent",
      "Database med Flyway-migrasjoner og HikariCP-konfig",
    ],
  },
  {
    title: "Review",
