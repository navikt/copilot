...
/**
 * Redirect handler for VS Code instructions installation.
 *
...
export async function GET(request: NextRequest) {
  ...
  if (!isAllowed) {
    return new Response("Invalid URL. Only navikt GitHub instructions installations are allowed.", { status: 400 });
  }
