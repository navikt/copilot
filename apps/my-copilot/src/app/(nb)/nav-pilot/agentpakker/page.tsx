                ...
                <section>
                  <VStack gap="space-16">
                    ...
                    <BodyLong textColor="subtle">
                      ...
                      <code className="font-mono text-xs">nav-pilot --persona &lt;navn&gt;</code> velger et annet av dem.
                      Hvert navn må ha en agentfil i <code className="font-mono text-xs">layout.agents</code>, ellers
                      avvises manifestet av <code className="font-mono text-xs">validate</code> og{" "}
