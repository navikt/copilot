...
| **rust-development** | Idiomatisk Rust-utvikling med cargo, clippy, error handling, async/tokio, unsafe og prosjektoppsett. Bruk for: nytt Rust-prosjekt, Cargo.toml-oppsett, feilhåndtering, unsafe-review, async-patterns, workspace-struktur, ytelsesoptimalisering, lint-konfig. | [`.github/skills/rust-development/`](../.github/skills/rust-development/SKILL.md) |
