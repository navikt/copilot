---
title: "Nyheter og trender for april 2026"
date: 2026-05-01
author: starefossen
draft: false
...
Data-residente forespørsler koster **10 % mer** i modellmultiplikator. Policyen er av som standard og aktiveres av Enterprise- eller organisasjonsadministrator.
...
## 4. `gh skill` gir agent skills fra terminalen
...
- **Claude Opus 4.7** (16. april) er bedre på flertrinnsoppgaver og pålitelig agentisk utførelse enn forgjengeren. Erstatter Opus 4.5 og 4.6 i modellvelgeren.
- **GPT-5.5** (24. april) har sterkest ytelse på komplekse, flerstegs agentoppgaver i GitHubs egen testing.
