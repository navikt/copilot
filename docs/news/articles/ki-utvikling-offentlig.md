---
title: "ki-utvikling.nav.no er nå åpen for alle"
date: 2026-05-05
author: starefossen
category: nav
...
1. `brew install copilot-cli` gir deg GitHub Copilot i terminalen
2. `brew install navikt/tap/nav-pilot` og `brew install navikt/tap/cplt` gir deg Nav-verktøyene
