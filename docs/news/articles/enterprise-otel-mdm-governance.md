...
- **Native MDM** via Microsoft Intune, Jamf eller Group Policy (Windows Registry / macOS managed preferences)
- **Server-managed**, der innstillingene løses fra den innloggede GitHub-kontoen
- **Filbasert**, der `managed-settings.json` deployes med Chef, Puppet, Ansible eller lignende
