...
Dette dokumentet er kontrakten, og det eneste stedet den står. Skal du lage din første pakke, følg oppskrifta på https://ki-utvikling.nav.no/nav-pilot/agentpakker og slå opp her underveis. Interndesignet, altså hvordan manifestet trådes gjennom install og sync, står i [cli/nav-pilot/DESIGN.md](../cli/nav-pilot/DESIGN.md).
